...
import com.coc.basemodule.base.BaseDialogFragment;
import com.coc.basemodule.utils.utils_base.Timestamp;
import com.coc.basemodule.config.Config_FilePath;
import com.coc.basemodule.utils.utils_func.ExtraPermissionsHelper;
        ...
        Observable.just(jpegArray)
                .map(new Function<byte[], String>() {
                    ...
                    public String apply(@NonNull byte[] bytes) throws Exception {
                        File file = new File(Config_FilePath.DIR_CAMERA_PATH);
                        if (!file.exists()) file.mkdirs();
                        String localStoragePath = Config_FilePath.DIR_CAMERA_PATH + File.separator + System.currentTimeMillis() + ".jpg";
